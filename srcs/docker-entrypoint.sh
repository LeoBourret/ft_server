...
wget -c https://files.phpmyadmin.net/phpMyAdmin/5.1.0/phpMyAdmin-5.1.0-english.tar.gz -O - | tar -xz -C /var/www
mv var/www/phpMyAdmin-5.1.0-english var/www/phpmyadmin
